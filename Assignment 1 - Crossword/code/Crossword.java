...
public class Crossword
{
	...
	//COMMAND LINE EXAMPLE: java Crossword dict8.txt test3a.txt
	...
	public Crossword() throws IOException{
		...
		System.out.println("NO SOLUTION FOUND"); //only will get to this line if no solution is found in Solve()
	}

	private void Solve(int row, int col) {
		if(theBoard[row][col] != '-') { //the square is a + or letter
